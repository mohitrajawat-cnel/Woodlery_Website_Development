...
if ( ! function_exists( 'zakra_head' ) ) :
	...
	function zakra_head() {
		...
		#header-action .tg-icon.tg-icon-shopping-cart
		{
		...
		#header-action .header-action-list li.menu-item:nth-child(1)
		{
			width:100%;
		}
		#header-action .header-action-list li.menu-item:nth-child(1) .search-form
		{
			width:78% !important;
		}
		.custom-logo
				...
				function zakra_header_main_action() {
					...
					<div id="header-action" class="<?php zakra_css_class( 'zakra_header_action_class' ); ?>">
							<ul class="header-action-list">
								...
								?>
								<li><img src="<?php echo get_site_url(); ?>/wp-content/uploads/tracking_icon.png" style="width: 29px;"></li>
								<li><a href="<?php echo get_site_url(); ?>/my-account"><span class="material-symbols-outlined" style="font-weight:bold;font-size:32px;">person</span></a></li>
								<!-- <li><span class="material-symbols-outlined">phone_in_talk</span> 963 56 7894</li> -->
					</div>
